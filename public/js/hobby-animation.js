...
var HobbyAnimation = function(container) {
    ...
    this.init = function() {
        var html = 
            ...
            '            <h4>MY HOBBIES</h4>' +
            '            <p>This visualization is also built on top of d3.js. It shows my hobby changes over time. The darker the color is, the better I love that hobby :)</p>' +
            '            <p>It seems that I am always curious about anything. Life is short, try as many different things as possible! </p>' +
            '        </div>' + 
            '    </div>' +
